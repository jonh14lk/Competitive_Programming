...
// 2- poligono convexo: um poligono cujo todos os seus angulos internos sao menores do que 180 graus

// convex hull:
// dados n pontos em um plano, o objetivo e achar o menor poligono convexo que possui todos os n pontos dados
// Graham's Scan, complexidade O(n * log(n))

// ideia do algoritimo:
// 1- ache 2 pontos a e b tal que, a e o ponto mais a esquerda e b o ponto mais a direita do conjunto dado
// 2- a e b devem pertencer ao convex hull
// 3- desenhar uma linha ab, essa linha ira separar os outros pontos em 2 conjuntos s1 (superior) e s2 (inferior).
...
// 7- para cada ponto, se o ponto dado pertence ao conjunto superior, verificamos o angulo formado pela linha
//    que liga o penultimo ponto e o ultimo ponto do convex hull superior, com a linha que conecta o
//    ultimo ponto do convex hull e o ponto atual. Se o angulo nao for no sentido horario,
//    removemos o ponto mais recente adicionado ao convex hull superior, pois o ponto atual sera capaz
