...
// e uma aresta entre dois vertices tal que os blocos correspondentes tem um vertice em comum

// block-cut tree
// um ponto de articulacao eh um vertice que esta em dois ou mais blocos
// a estrutura dos blocos e dos pontos de articulacao de um grafo conectado pode ser descrita por uma arvore chamada de arvore de block-cut tree
// essa arvore tem um vertice para cada bloco e para cada ponto de articulacao do grafo dado.
// tem uma aresta na block-cut tree para cada par (bloco, ponto de articulacao), tal que esse ponto de articulacao ta no bloco

// para o problema:
// para um grafo nao bipartido que e biconexo, tem caminhos de tamanho impar e par entre qualquer par de vertices
