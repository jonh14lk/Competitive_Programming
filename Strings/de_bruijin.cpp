...
signed main()
{
  ...
  sz = n + k - 1;
  if (n >= 40) // n grande -> a probabilidade de colisão eh muito baixa
  {
    string s;
    for (int i = 0; i < sz; i++)
    {
...
// ai vai ser tipo:
// achar uma string na qual todas as substrings de tamanho n são distintas

// além disso, o alfabeto contem m letras
