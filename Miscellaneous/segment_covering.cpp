...
// para cada segmento [l[i], r[i]], pelo menos um ponto escolhido tá nesse segmento
// tem a solução gulosa em O(N)
...
// dado um conjunto de n segmentos [l[i], r[i]]
// você quer selecionar o número minimo de segmentos do conjunto
// para cobrir todo o segmento [a, b]
// bem parecido, tem uma solução gulosa normal
