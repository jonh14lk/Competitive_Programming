...
// temos que fazer algo parecido com um mos algorithm
// sendo que a operação eh um union/rollback do dsu
...
// acredito que a complexidade disso fique algo em torno de (n * sqrt(n)), sem considerar a complexidade do dsu
